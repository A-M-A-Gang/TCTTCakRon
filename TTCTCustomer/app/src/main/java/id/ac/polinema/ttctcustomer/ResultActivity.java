...
import id.ac.polinema.ttctcustomer.adapter.ResultCustomer;
import id.ac.polinema.ttctcustomer.models.KeranjangMenu;
import id.ac.polinema.ttctcustomer.models.Order;
...
public class ResultActivity extends AppCompatActivity {
    ...
    private ResultCustomer mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseMenu.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                mAdapter = new ResultCustomer(ResultActivity.this, menuList);
