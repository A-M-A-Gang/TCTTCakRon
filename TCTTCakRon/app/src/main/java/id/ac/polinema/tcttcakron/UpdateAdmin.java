...
//        MenuUpdate hero13 = new MenuUpdate("Iwa");
//        //menambahkan hero ke listSuperHero
//        listSuperHero.add(hero13);
//
//        MenuUpdate hero14 = new MenuUpdate("Iwa");
//        //menambahkan hero ke listSuperHero
//        listSuperHero.add(hero14);
//
//        MenuUpdate hero15 = new MenuUpdate("Iwa");
//        //menambahkan hero ke listSuperHero
//        listSuperHero.add(hero15);
//
//        //Instansiasi Adapter
//        MenuUpdateAdapter superHeroAdapter = new MenuUpdateAdapter(listSuperHero);
...
//        rvMenu = findViewById(R.id.recycleview_menu);
...
//        //Membuat object hero
//        Upload menu = new Upload("Test", "kokok", 9000);
//        //menambahkan hero ke listSuperHero
//        listMenu.add(menu);
